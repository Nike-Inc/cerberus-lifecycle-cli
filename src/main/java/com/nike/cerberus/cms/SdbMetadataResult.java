...
public class SdbMetadataResult {
    ...
    private List<SafeDepositBox> safeDepositBoxMetadata;
    ...
    public List<SafeDepositBox> getSafeDepositBoxMetadata() {
        return safeDepositBoxMetadata;
    }

    public void setSafeDepositBoxMetadata(List<SafeDepositBox> safeDepositBoxMetadata) {
