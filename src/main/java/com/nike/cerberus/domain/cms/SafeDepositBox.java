...
public class SafeDepositBox {
    ...
    public void setCreatedTs(String dateString) {
        this.createdTs = OffsetDateTime.parse(dateString);
    }
    ...
    public void setLastUpdatedTs(String dateString) {
        this.lastUpdatedTs = OffsetDateTime.parse(dateString);
    }
