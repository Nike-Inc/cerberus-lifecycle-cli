...
public class VpcOutputs {
    ...
    public VpcOutputs setVpcHostedZoneId(String vpcHostedZoneId) {
    ...
    public VpcOutputs setVpcSubnetIdForAz1(String vpcSubnetIdForAz1) {
    ...
    public VpcOutputs setVpcSubnetIdForAz2(String vpcSubnetIdForAz2) {
    ...
    public VpcOutputs setVpcSubnetIdForAz3(String vpcSubnetIdForAz3) {
